@echo off
REM RevitMCP AI Render Server Launcher
REM
REM This script starts the AI render server for architectural visualization.
...
set SERVER_SCRIPT=%~dp0render_server.py
...
if not exist "%VENV_PATH%\Scripts\python.exe" (
    echo.
    echo AI Render environment not found.
    echo.
...
REM === Start server ===
echo.
echo Starting AI Render Server...
echo.
